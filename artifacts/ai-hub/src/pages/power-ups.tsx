...
function TemplateCard({ template, onActivate, onRunNow, activated }: {
  ...
  return (
    <motion.div
      ...
      className="flex flex-col bg-white border border-gray-100 rounded-2xl p-5 hover:border-gray-200 transition-all group"
    >
      {/* Top row */}
      <div className="flex items-start justify-between gap-3 mb-3">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="text-sm font-display font-bold text-gray-800 leading-tight">{template.name}</h3>
            <span
      ...
      <div className="flex flex-wrap gap-1.5 mb-4">
        {(template.useCases ?? []).map(uc => (
          <span key={uc} className="text-[10px] text-gray-400 bg-gray-50 px-2 py-0.5 rounded-md">{uc}</span>
        ))}
      </div>
      ...
      <div className="flex gap-2 mt-auto">
        <button
          onClick={onRunNow}
          className="flex-1 flex items-center justify-center gap-1.5 py-2 rounded-xl text-xs font-semibold bg-primary text-gray-900 hover:bg-primary/90 transition-all"
        >
        ...
        <button
          ...
          className={cn(
            ...
            activated
              ...
              : 'border-gray-200 text-gray-400 hover:text-gray-900 hover:border-white/20'
          )}
        >
                ...
                return (
                  <button
                    ...
                    className={cn(
                      ...
                      activeCategory === cat ? 'text-gray-900' : 'text-gray-400 hover:text-gray-500'
                    )}
