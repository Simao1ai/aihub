...
const PLATFORMS = [
  {
    ...
    timeEstimate: '~1 min',
    quickGuide: {
      title: 'Connect Facebook with OAuth',
      steps: [
        { text: 'Click "Connect Meta / Facebook with OAuth" below' },
        { text: 'A Facebook login popup opens — sign in with the account that manages your Pages' },
        { text: 'Approve the permissions (pages_show_list, pages_manage_posts, pages_read_engagement, pages_manage_engagement)' },
        { text: 'SynthDesk fetches all your Pages and stores permanent tokens automatically — done!' },
      ],
