...
const PLATFORMS = [
  {
    ...
    quickGuide: {
      ...
      steps: [
        { text: 'Open the Graph API Explorer (link below)', link: 'https://developers.facebook.com/tools/explorer/' },
        { text: 'Top-right dropdown: select your Meta App (e.g. "aihub")' },
        { text: 'Click "Generate Access Token" → log in → Approve' },
        { text: 'In the left panel, click "Get Page Access Token" → select your Facebook Page' },
        { text: 'Copy the Page Access Token and paste it below' },
      ],
      redirectPath: '',
      tokenGuide: 'A Page Access Token gives your AI agents direct posting rights to your Facebook Page and connected Instagram. It\'s more reliable than user OAuth for a private business tool.',
